...
$(package)_download_path=http://download.qt.io/archive/qt/4.6/qt-everywhere-opensource-src-4.6.4.tar.gz
$(package)_file_name=qt-everywhere-opensource-src-4.6.4.tar.gz
